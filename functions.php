...
function forty_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => esc_html__( 'Footer', 'forty' ),
			'id'            => 'footer-1',
			'description'   => esc_html__( 'Add footer widgets here.', 'forty' ),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h2 class="widget-title">',
			'after_title'   => '</h2>',
...
function forty_scripts() {
	...
	wp_enqueue_script( 'util', get_template_directory_uri() . '/assets/js/util.js', array(), _S_VERSION, 'all' );	
